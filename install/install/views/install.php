                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="configuration-tab">
                            <form name="config-form" id="config-form" action="./index.php/ajax_install" method="post">
                                ...
                                <div class="section clearfix">
                                    <p>2. Admin Credentials (Dont Change Admin Credentials Below in Form)</p>
                           <strong>        <li>Remain default admin credentials only afterwards you can change it from profile.</li>    </strong>
                           <strong>  <li>If you change any admin details from here it would not work so be careful.</li>    </strong>
                                    <li>Admin Email - admin@admin.com</li>
                                    <li>Admin Pass - 123456</li>
                                    <hr />
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="Admin"  id="first_name"  name="first_name" class="form-control"  placeholder="First Name" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class=" col-md-9">
                                                <input type="text" value="admin@admin.com" name="email" class="form-control" placeholder="Your email" />
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                            <label for="password" class=" col-md-3">Password</label>
                                            <div class=" col-md-9">
                                                <input type="password" value="123456" name="password" class="form-control" placeholder="Login password"/>
                                            </div>
                                        </div>
                                        <div class="form-group clearfix">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="ab912eb7-853a-6c1c-83af-d51c4d100eab"  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Find in codecanyon item download section" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
